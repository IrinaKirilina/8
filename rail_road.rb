...
class RailRoad
  ...
  def car_add
    ...
    if train_number && train_type
      ...
      if train 
        ...
        if car_type
          if car_type == :cargo
            car = CargoCar.new(car_number, capacity)
          else
            car = PassengerCar.new(car_number, capacity)
          end
          train.add_car(car)
          puts "Вагон добавлен"
        else
 ...
 # Выводить список вагонов у поезда (используя созданные методы):
 ...
 # - кол-во свободных и занятых мест (для пассажирского вагона) или кол-во свободного и занятого объема (для грузовых вагонов).
  ...
  # Выводить список поездов на станции (используя  созданные методы):
  # - Номер поезда
  # - тип
  # - кол-во вагонов
  ...
  # Добавить возможность занимать место или объем в вагоне
